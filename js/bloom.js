	...
	******************************************************************************************************************/
	...
	$(document).ready(function(){
		 ...
		 //Pretty Photo
		 $('.ff-items a, .slides a.pretty').prettyPhoto({deeplinking: false, show_title: false, social_tools: '', theme: 'pp_default'});			
 			
 			$("#map a[rel^='prettyPhoto']").prettyPhoto({
		...
		// Fade Images
		 $('.facebook, .twitter, .forrst, .vimeo, .team-fade, .close, .next, .prev, .zoom, .mapimg').append('<span class="hover"></span>').each(function () {
	...
	******************************************************************************************************************/
	...
	$(".proj").click(function (event) {
	    ...
	    if(!($(".openproject").hasClass("active"))) {
	      $(".openproject."+getProject).fadeIn(openTime).animate({height: "600px"}, openTime).addClass("active");
	      loadImages();
	      ...
	      $(".openproject."+getProject).fadeIn(openTime).addClass("active").animate({height: "600px"}, openTime);
	      loadImages();
